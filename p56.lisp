...
(define-test symmetric-test
  (let ((symmetric-trees '(nil
    ...
    (loop for tree in symmetric-trees do (assert-true (symmetric tree) tree))
    (loop for atree in asymmetric-trees do (assert-false (symmetric atree)))))
